                    ...
                    <div className="">
                        ...
                        <div className="mx-auto flex-col lg:flex-row   gap-8  lg:mx-0 lg:max-w-6xl flex">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-base leading-7 text-gray-300 dark:text-gray-400">Please select the desired quantity on the payment page (we prefill the quantity you selected on step 1) and proceed with the payment.</p>
                            </div>
                            <div>
                                <div className="flex items-center  text-lg font-semibold leading-6 text-blue-400">
                                    <svg viewBox="0 0 4 4" className="mr-4 h-1 w-1 flex-none" aria-hidden="true">
